...
const interviewReportSchema = z.object({
    matchScore: z.number().int().min(0).max(100).describe("An integer number between 0 and 100 indicating match percentage. Do NOT return fractions like '7/10' or strings. Return only a single raw number like 70."),
